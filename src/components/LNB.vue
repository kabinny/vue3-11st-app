<template>
  <nav
    ...
    <div
      ...
      <div class="group categories">
        ...
        <ul class="group__list">
          <li
            v-for="(item1, index) in nav.categories.list"
            :key="item1.name"
            :class="{ hover: categoryHover === index }"
            @mouseenter.stop="categoryHover = index">
      ...
      <div
        ...
        <div class="group__title">
          {{ nav.majorServices.title }}
        </div>
        <ul class="group__list">
          <li
            v-for="item in nav.majorServices.list"
            :key="item.name">
            <a :href="item.href">
              {{ item.name }}
            </a>
      ...
      <div
        ...
        <ul
          ...
          class="group__list">
          <li
            v-for="item in nav.outlets.list"
            :key="item.name">
            <a :href="item.href">
              <img
                :src="item.src"
      ...
      <div
        ...
        <ul
          ...
          class="group__list">
          <li
            v-for="item in nav.partners.list"
            :key="item.name">
            <a :href="item.href">
              <img
                :src="item.src"
      ...
      <div
        ...
        <ul
          ...
          class="group__list">
          <li
            v-for="item in nav.brandMall.list"
            :key="item.name">
            <a :href="item.href">
              <img
                :src="item.src"
    ...
    <div class="exhibitions">
      <a :href="nav.exhibitions.href">
        <img
          :src="nav.exhibitions.src"
          :alt="nav.exhibitions.name" />
      </a>
    </div>
  </nav>
...
export default {
  ...
  methods: {
    ...
    toggleGroup(name) {
      const computedName = `isShow${_upperFirst(name)}`
      this.$data[computedName] = !this.$data[computedName]
      if (this.$data[computedName]) {
        this.$nextTick(() => {
          this.$refs.container.scrollTop = this.$refs[name].offsetTop - 80
        })
      }
    }
  }
